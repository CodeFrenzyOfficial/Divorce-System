...
import Step6Schema from "@/app/schemas/stepform-schemas/step6";
...
export default function page() {
    ...
    const questions = (StepOneQuestionair && StepOneQuestionair[5]);
    ...
    const onSubmit = (formdata) => {
        if (formdata) push("/step-form/steps/7")
    }
        ...
        <div className="py-10">
            <Form {...form}>
                <h3 className="font-semibold text-2xl mb-8">
                    {questions ? questions.name : "Community Property"}
                </h3>
                ...
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="flex flex-col items-start md:items-center md:flex-row justify-between gap-4">
                        <h2 className="w-full md:w-1/2">
                            {questions ? questions?.questions[0].question : "* Do you and your spouse plan to divide the things you bought together during the marriage equally?"}
                        </h2>
                    ...
                    <div className="w-fit p-4 bg-blue-100 flex gap-2 items-center justify-start">
                        ...
                        <p className="font-light text-sm">
                            Property purchased this way is called “community property” and is usually divided equally. More information on this topic will be provided after you complete your registration.
                        </p>
                    </div>
